...
const Hero = () => {
  ...
  return (
    <div className="hero relative w-screen h-auto overflow-hidden" id="hero">
      {/* <div className="overlay w-full h-full absolute top-0 left-0 bg-black bg-opacity-20 z-[2]"></div> */}
      <div className="mx-auto w-full h-full">
      <Slider {...settings}>
        <div>
          <img src="assets/hero/hero-bg-1.png" alt="Slide 1" className="w-full" />
        </div>
        <div>
          <img src="assets/hero/hero-bg-1.png" alt="Slide 2" className="w-full" />
        </div>
        {/* <div>
