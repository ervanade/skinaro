...
const About = () => {
  ...
  return (
    <div className="about grid lg:grid-cols-2 gap-4 px-6 py-16 md:px-10 lg:px-10 bg-cover bg-no-repeat" id='why-aro' style={{ backgroundImage: `url(assets/about/about-bg.png)` }}>
      <div className="left-about w-full object-cover">
        <img src="assets/about-img.png" alt="" className="w-full h-full object-cover" />
      </div>
      <div className="right-aboutflex flex-col justify-center px-6 w-full">
